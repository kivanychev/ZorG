...
void HAL_DCMI_MspDeInit(DCMI_HandleTypeDef* hdcmi)
{
  ...
  /* USER CODE END DCMI_MspDeInit 0 */
    ...
    PA6     ------> DCMI_PIXCLK
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_1|GPIO_PIN_0|GPIO_PIN_6);

    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_8);

    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_11);

    HAL_GPIO_DeInit(GPIOI, GPIO_PIN_4|GPIO_PIN_5);

    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_4|GPIO_PIN_6);
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOK, GPIO_PIN_7|GPIO_PIN_5|GPIO_PIN_4);
